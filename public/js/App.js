...
var placesList = exports.placesList = {
...
var getMatchedPlaces = exports.getMatchedPlaces = function getMatchedPlaces() {
	var keyword = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";

	var lowercaseKeyword = keyword.toLowerCase().trim();
	return Object.keys(placesList).filter(function (item) {
		return item.toLowerCase().indexOf(lowercaseKeyword) > -1;
	});
};

var getLongLat = exports.getLongLat = function getLongLat(place) {
	return placesList[place];
};

var navbarHeight = exports.navbarHeight = 80;
var marginBottom = exports.marginBottom = 40;
var isDesktop = exports.isDesktop = $(document).width() >= 992;
...
var _PopularPlaces = __webpack_require__(36);

var _PopularPlaces2 = _interopRequireDefault(_PopularPlaces);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"aside",
							{ className: "col-lg-3 neighborhood-map__aside left-aside" },
							_react2.default.createElement(_Filter2.default, { setAppState: this.setAppState, currentKeyword: this.state.currentKeyword })
						),
						_react2.default.createElement(
							"main",
						...
						_react2.default.createElement(
							"aside",
							{ className: "col-lg-3 neighborhood-map__aside right-aside" },
							_react2.default.createElement(_PopularPlaces2.default, { popularPlaces: this.state.popularPlaces, selectedCity: this.state.selectedCity })
						)
					)
				)
			);
...
_reactDom2.default.render(_react2.default.createElement(App, null), document.querySelector('.neighborhood-map'));
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(8),B=__webpack_require__(2),C=__webpack_require__(1),ba=__webpack_require__(9),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ia=__webpack_require__(13),D=__webpack_require__(3);
...
var Filter = function (_React$Component) {
	...
	function Filter() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Filter.__proto__ || Object.getPrototypeOf(Filter)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			_this.props.setAppState(state);
		}, _this.handleKeywordChange = function (e) {
			var value = e.target.value;
			_this.setAppState({ currentKeyword: value });
		}, _this.handleLocationClick = function (e) {
			var value = e.target.innerText;
			_this.setAppState({ currentKeyword: value });
		}, _this.clearFilter = function () {
			_this.setAppState({ currentKeyword: "" });
	...
	_createClass(Filter, [{
		...
		value: function render() {
			...
			var currentKeyword = this.props.currentKeyword;
			var matchPlaces = (0, _misc.getMatchedPlaces)(currentKeyword);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "col-4 text-right animated fadeIn " + (clearBtnIsHidden ? 'hidden' : "") },
						_react2.default.createElement(
							"a",
							{ href: "#",
								tabIndex: "1",
...
var Map = function (_React$Component) {
	...
	function Map() {
		...
		_this.initMap = function () {
			...
			Object.keys(_misc.placesList).forEach(function (place) {
				_this.setMarker(place);
			});
		};
		...
		_this.markers = [];
		_this.matchedPlaces = Object.keys(_misc.placesList); // Since we set it to all places for the initial state
		_this.setMarkerTimeout = null;
		return _this;
	}
	...
	_createClass(Map, [{
		...
		value: function setMarkers() {
			...
			this.setMarkerTimeout = setTimeout(function () {
				var currentKeyword = _this2.props.currentKeyword;
				var matchedPlaces = (0, _misc.getMatchedPlaces)(currentKeyword);
				var matchedPlacesHaveChanged = JSON.stringify(matchedPlaces) !== JSON.stringify(_this2.matchedPlaces);
				_this2.matchedPlaces = matchedPlaces;

				// Only set the markers, if they have changed.
				if (matchedPlacesHaveChanged) {
					_this2.clearAllMarkers();
					matchedPlaces.forEach(function (place) {
						return _this2.setMarker(place);
					});
				}
			}, 300);
		}
...
var PopularPlaces = function (_React$Component) {
	...
	_createClass(PopularPlaces, [{
		...
		value: function render() {
			...
			var titleHeight = 24;
			var widgetHeight = _misc.isDesktop ? $(window).height() - _misc.navbarHeight - _misc.marginBottom - titleHeight : "auto";
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"ul",
					{ className: "list-group shadow rounded", style: { height: widgetHeight } },
					placeNodes
				)
			);
		}
